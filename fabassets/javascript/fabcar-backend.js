...
// This method checks if the given asset exists and executes callback depending on success / failure
async function assetExists(assetID, success, failure){
...
async function invoke(request, socket){
    ...
    if (proposalResponses && proposalResponses[0].response &&
        proposalResponses[0].response.status === 200) {
            ...
            socket.emit('RESPONSE',{type: 'ERROR' , payload: proposalResponses[0].message})
